...
Starts the Express backend (port from `.env`, default 4173) and the Vite dev server (port 5173) in one terminal. Vite proxies `/api/*` to Express. Open **http://localhost:5173**. Edit `PUTER.md` and refresh to see changes immediately.
